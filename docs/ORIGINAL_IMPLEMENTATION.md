# Clutch Chess - Original Implementation Documentation

This document provides a comprehensive reference of the original Clutch Chess implementation located at `/home/jeffr/code/kfchess`. Use this as a reference when rebuilding the game.
...
Clutch Chess is a **real-time, turn-free chess game** where players can move pieces simultaneously. Unlike traditional chess, there are no turns - both players can move any of their pieces at any time, subject to cooldown periods after each move.
