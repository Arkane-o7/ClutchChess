"""Replay recording and playback for Clutch Chess.
...
from clutchchess.game.state import TICK_RATE_HZ, GameStatus, ReplayMove, Speed

if TYPE_CHECKING:
    from clutchchess.game.state import GameState
...
def _convert_v1_to_v2(data: dict[str, Any]) -> Replay:
    ...
    V1 format (from ../clutchchess/lib/replay.py):
    {
        "speed": "standard",
